...
function AppLogo({ exe, className = "h-5 w-5 shrink-0 object-contain" }: { exe: string; className?: string }) {
  const clean = exe.toLowerCase();

  const iconMap: Record<string, string> = {
    "chrome.exe": "/app-icons/chrome.svg",
    "msedge.exe": "/app-icons/edge.svg",
    "edge.exe": "/app-icons/edge.svg",
    "firefox.exe": "/app-icons/firefox.svg",
    "brave.exe": "/app-icons/brave.svg",
    "discord.exe": "/app-icons/discord.svg",
    "spotify.exe": "/app-icons/spotify.svg",
    "steam.exe": "/app-icons/steam.svg",
    "telegram.exe": "/app-icons/telegram.svg",
    "whatsapp.exe": "/app-icons/whatsapp.svg",
    "code.exe": "/app-icons/vscode.svg",
    "vscode.exe": "/app-icons/vscode.svg",
    "notion.exe": "/app-icons/notion.svg",
    "obs64.exe": "/app-icons/obs.svg",
    "obs.exe": "/app-icons/obs.svg",
    "vlc.exe": "/app-icons/vlc.svg",
  };

  const iconSrc = iconMap[clean];

  if (iconSrc) {
    return <img src={iconSrc} alt={clean} className={className} />;
  }
