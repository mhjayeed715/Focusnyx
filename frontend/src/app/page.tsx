          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_0.92fr] lg:px-8 lg:py-22 xl:grid-cols-[1.02fr_0.98fr]">
            ...
            >
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                ...
                <a href="https://github.com/mhjayeed715/Focusnyx/releases/download/v1.0.0/Focusnyx-Chrome-Extension.zip" target="_blank" rel="noreferrer" className="secondary-button flex h-12 items-center justify-center gap-2 px-5 text-sm sm:h-14 sm:px-6 sm:text-base bg-[#ECFDF5]">
                  <Puzzle size={18} strokeWidth={2.5} className="text-[#059669]" />
                  {lang === "bn" ? "এক্সটেনশন (ZIP)" : "Extension (ZIP)"}
                </a>
                <a href="https://github.com/mhjayeed715/Focusnyx/releases/download/v1.0.0/FocusnyxCompanionApp-Windows.zip" target="_blank" rel="noreferrer" className="secondary-button flex h-12 items-center justify-center gap-2 px-5 text-sm sm:h-14 sm:px-6 sm:text-base bg-[#F3E8FF]">
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.95fr] lg:px-8">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a href="https://github.com/mhjayeed715/Focusnyx/releases/download/v1.0.0/Focusnyx-Chrome-Extension.zip" target="_blank" rel="noreferrer" className="candy-button flex h-13 items-center justify-center gap-3 px-6 text-sm">
                  <Puzzle size={20} strokeWidth={2.5} />
                  {lang === "bn" ? "Chrome এক্সটেনশন ডাউনলোড" : "Download Chrome Extension"}
                  <Download size={18} strokeWidth={2.5} />
                </a>
                <a href="https://github.com/mhjayeed715/Focusnyx/releases/download/v1.0.0/FocusnyxCompanionApp-Windows.zip" target="_blank" rel="noreferrer" className="secondary-button flex h-13 items-center justify-center gap-3 px-6 text-sm bg-white">
